# ==============================================================================
# 🚀 SatQuery AI — Kaggle Dual-GPU 50,000 Samples Fine-Tuning Notebook
...
# ==============================================================================
# Step 3: Create 50,000 Samples Data Preparation Script
# ==============================================================================
print("\n" + "="*60)
print("Step 3: Setting up 50,000 Samples Dataset Converter...")
print("="*60)
...
# Download RSVQA LR Train Questions and Answers
...
if not os.path.exists("data/LR_split_train_questions.json"):
    print("Downloading train questions...")
...
print("Processing 50,000 training samples...")
...
print(f"Total valid samples prepared: {len(records)}")
with open("train_50k.jsonl", "w", encoding="utf-8") as f:
    for r in records:
        f.write(json.dumps(r) + "\\n")

print("Saved train_50k.jsonl successfully!")
'''

with open("prepare_50k.py", "w", encoding="utf-8") as f:
    f.write(prep_code)

os.system("python prepare_50k.py")

# ==============================================================================
# Step 4: QLoRA 4-Bit Training Execution
# ==============================================================================
print("\n" + "="*60)
print("Step 4: Executing QLoRA 4-Bit Multi-GPU Training...")
print("="*60)
...
if __name__ == "__main__":
    train_lora("train_50k.jsonl", "lora_50k_adapter", epochs=2)
'''

with open("train_50k_script.py", "w", encoding="utf-8") as f:
    f.write(train_code)

os.system("python train_50k_script.py")

# Zip output adapter for 1-click download
os.system("zip -r lora_50k_adapter.zip lora_50k_adapter")
print("\n" + "="*60)
print("🎉 FINISHED! You can now download lora_50k_adapter.zip directly from Kaggle output!")
print("="*60)
